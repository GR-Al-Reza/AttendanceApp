...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_CLASS_TABLE=
            "CREATE TABLE " +CLASS_TABLE_NAME + "(" +
                    ...
                    CLASS_TABLE_NAME+"TEXT NOT NULL,"+
    ...
    private static final String DROP_STATUS_TABLE="DROP TABLE IF EXISTS " +STUDENT_TABLE_NAME;
    private static final String SELECT_STATUS_TABLE="SELECT * FROM"+STUDENT_TABLE_NAME;
